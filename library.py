...
check_in(book_title = "THE POWER OF MOMENTS")
...
# There is a list of Dictionarys with keys Title, Author, and Discription with values answering each for each idividual book
...
yuval_harari_books = search_by_author('Yuval Noah Harari')
print(yuval_harari_books)